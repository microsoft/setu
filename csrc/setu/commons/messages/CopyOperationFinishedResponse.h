...
struct CopyOperationFinishedResponse : public BaseResponse {
  ...
  static CopyOperationFinishedResponse Deserialize(const BinaryRange& range);
};
using CopyOperationFinishedResponsePtr =
    std::shared_ptr<CopyOperationFinishedResponse>;
