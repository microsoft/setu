...
struct WaitForCopyRequest : public BaseRequest {
  ...
  [[nodiscard]] std::string ToString() const {
    return std::format(
        "WaitForCopyRequest(request_id={}, copy_operation_id={})", request_id,
        copy_operation_id);
  }
